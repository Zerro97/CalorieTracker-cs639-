...
export default class MealCreateScreen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            foods: {},
                ...
                <View style={styles.inner}>
                  ...
                  <View style={{padding: 24}}>
                    <View style={{marginBottom: 20, alignItems: 'center', justifyContent: 'center', height: 50}}>
                      <Text style={styles.sectionHeading}>Create Meal</Text>
                    </View>
                    ...
                    <TouchableOpacity style={styles.btnContainer} onPress={this.createMeal}>
                        <Text style={styles.btnText}>Create Meal</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              </SafeAreaView>
